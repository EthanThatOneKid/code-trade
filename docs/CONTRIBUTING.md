...
## Deployment
Follow the instructions of [this article](https://dev.to/pixeline/how-to-deploy-a-sapper-pwa-on-github-pages-47lc) to deploy the application on GitHub Pages. Fill out the secrets within the [.env](SAMPLE.env) file.
